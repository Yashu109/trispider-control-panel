...
//   const [query, setQuery] = useState(''); // For storing the query
...
//               </div>
//               <div className="dashboard-form-group">
//                 <button type="button" onClick={handleSendQuery}>
//                   Send Query
//                 </button>
//               </div>
//             </div>
...
const UserDashboard = () => {
  ...
  //         // Clear query status after 5 seconds
  //         setTimeout(() => {
  //           update(orderRef, { queryStatus: null });
  //         }, 5000);
  //       }
  //     } else {
  //       console.error('Order not found');
